...
function is_grub2_bls_in_use() {
    ...
    # - RHEL 8-based systems use only /boot/efi/EFI/redhat/grub.cfg
    # - RHEL 9 and 10-based systems use both /boot/efi/EFI/redhat/grub.cfg and
    #   /boot/grub2/grub.cfg.
    #
    # In RHEL 9 and 10, /boot/grub2/grub.cfg contains the real configuration,
    # and /boot/efi/EFI/redhat/grub.cfg loads it using the configfile command.
    local grub_cfg
